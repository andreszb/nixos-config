  ...
  xdg_stateHome  = "${home}/.local/state"; in
{
  ...
  "${xdg_configHome}/bspwm/bspwmrc" = {
    ...
    text = ''
      ...
      /etc/profiles/per-user/andreszb/bin/google-chrome-stable "https://www.fastmail.com" "https://calendar.google.com/calendar/u/0/r" "https://www.techmeme.com"  &!
      ...
      /etc/profiles/per-user/andreszb/bin/alacritty -e sh -c 'tmux attach || tmux new-session' &
      ...
      /etc/profiles/per-user/andreszb/bin/google-chrome-stable --new-window "https://chat.openai.com" &!
      ...
      /etc/profiles/per-user/andreszb/bin/cider &!
